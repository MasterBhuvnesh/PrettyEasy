        ...
        <View className="flex-1 pb-24">
          ...
          <View className="w-full max-w-md mx-auto px-4">
            ...
            >
              {({
                ...
                <View className="w-full">
                  <Text className="text-[#ff4380] font-semibold text-base mb-1">
                    Name
                  </Text>
                  <TextInput
                  ...
                  <Text className="text-[#ff4380] font-semibold text-base mb-1 mt-2">
                    Email
                  </Text>
                  <TextInput
            ...
            <View>
              ...
              >
                <Text className="text-[#ff9994] font-semibold">
                  Already a user?{" "}
                </Text>
